...
//func TestHalfkeyFromPrefix(t *testing.T) {
//	tests := []struct {
//		p    netip.Prefix
//		want halfkey
//	}{
//		{pfx("1.2.3.0/24"), hk(uint64(0x01020300<<32), 0, 24)},
//		// TODO add more
//	}
//	for _, tt := range tests {
//		if got := halfkeyFromPrefix(tt.p); got != tt.want {
//			t.Errorf("halfkeyFromPrefix(%v) = %q, want %q", tt.p, got, tt.want)
//		}
//	}
//}
...
//	}
//	for _, tt := range tests {
//		if got := halfkeyFromPrefix(tt.p).bit(tt.bit); got != tt.want {
//			t.Errorf("halfkeyFromPrefix(%v).bit(%v) = %q, want %q", tt.p, tt.bit, got,
//				tt.want)
//		}
//	}
//
