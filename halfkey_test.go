...
func TestHalfkeyString(t *testing.T) {
	tests := []struct {
		...
		{hk(uint128{0, 0}, 0, 0), "0,0"},
		{hk(uint128{0, 0}, 0, 1), "0,1"},
...
func TestHalfkeyIsPrefixOf(t *testing.T) {
	tests := []struct {
		...
		{hk(uint128{0, 0}, 0, 0), hk(uint128{0, 0}, 0, 0), true},
...
func TestHalfkeyNext(t *testing.T) {
	tests := []struct {
		...
		{hk(uint128{0, 0}, 0, 0), hk(uint128{0, 0}, 0, 1), hk(uint128{1 << 63, 0}, 0, 1)},
