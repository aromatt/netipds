...
func TestPrefixMapContainsLazy(t *testing.T) {
	tests := []struct {
		set  []netip.Prefix
		get  netip.Prefix
		want bool
...
func TestPrefixMapContainsAfterRemoveLazy(t *testing.T) {
	tests := []struct {
		set    []netip.Prefix
		remove []netip.Prefix
		get    netip.Prefix
...
func TestPrefixMapEncompassesLazy(t *testing.T) {
	tests := []struct {
		set  []netip.Prefix
		get  netip.Prefix
		want bool
...
func TestPrefixMapToMapLazy(t *testing.T) {
	tests := []struct {
		set  []netip.Prefix
...
func TestPrefixMapRemoveLazy(t *testing.T) {
	tests := []struct {
		set    []netip.Prefix
		remove []netip.Prefix
		want   map[netip.Prefix]bool
...
//func TestPrefixMapSubtractLazy(t *testing.T) {
//	tests := []struct {
//		set      []netip.Prefix
...
//// in gaps.
//func TestPrefixMapSubtractNoOverwriteLazy(t *testing.T) {
...
func TestPrefixMapParentOfLazy(t *testing.T) {
	tests := []struct {
		set        []netip.Prefix
		get        netip.Prefix
		wantPrefix netip.Prefix
...
func TestPrefixMapDescendantsOfLazy(t *testing.T) {
	tests := []struct {
		set  []netip.Prefix
		get  netip.Prefix
		want map[netip.Prefix]bool
...
func TestPrefixMapAncestorsOfLazy(t *testing.T) {
...
func TestPrefixMapBuilderUsableAfterPrefixMapLazy(t *testing.T) {
	pmb := &PrefixMapBuilder[int]{Lazy: true}
...
func TestPrefixMapBuilderFilterLazy(t *testing.T) {
	tests := []struct {
		set    []netip.Prefix
		filter []netip.Prefix
		want   map[netip.Prefix]bool
...
func TestPrefixMapFilterLazy(t *testing.T) {
	tests := []struct {
		set    []netip.Prefix
		filter []netip.Prefix
		want   map[netip.Prefix]bool
...
func TestOverlapsPrefixLazy(t *testing.T) {
	tests := []struct {
		set  []netip.Prefix
		get  netip.Prefix
		want bool
